...
export default function Map() {
  ...
  let iconMarker = new google.maps.MarkerImage('/water-fountain.jpg', null, null, null, new google.maps.Size(40, 40));
  ...
  let iconCurrentPosition = new google.maps.MarkerImage('/logo.png', null, null, null, new google.maps.Size(40, 40));
        ...
        >
          ...
          <FormGroup>
            <FormControlLabel
              ...
              label="Markers from People You Follow Only"
            />
            <FormControlLabel
              control={<Switch checked={review_fr} onChange={e => setreview_fr(e.target.checked)} />}
              label="Reviews from People You Follow Only"
            />
          </FormGroup>
          {showroute ? (
            <div
